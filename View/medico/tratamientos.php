    ...
    <body>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse" id="links">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#">Tratamientos</a></li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="introduccion">
                <h5>Tratamientos disponibles</h5>
            </div>
            <div class="contenido">
        ...
        <script type="text/javascript" src="../../recursos/javascript/tratamientosmedico.js"></script>
